...
class Ui_mmqgis_geometry_convert_form(object):
    def setupUi(self, mmqgis_geometry_convert_form):
        ...
        self.label = QtWidgets.QLabel(parent=mmqgis_geometry_convert_form)
        ...
        self.input_layer_name = QtWidgets.QComboBox(parent=mmqgis_geometry_convert_form)
        self.input_layer_name.setObjectName("input_layer_name")
        self.verticalLayout.addWidget(self.input_layer_name)
        self.old_geometry = QtWidgets.QLabel(parent=mmqgis_geometry_convert_form)
        self.old_geometry.setAlignment(QtCore.Qt.AlignmentFlag.AlignRight|QtCore.Qt.AlignmentFlag.AlignTop|QtCore.Qt.AlignmentFlag.AlignTrailing)
        self.old_geometry.setObjectName("old_geometry")
        self.verticalLayout.addWidget(self.old_geometry)
        self.label_3 = QtWidgets.QLabel(parent=mmqgis_geometry_convert_form)
        ...
        self.new_geometry = QtWidgets.QComboBox(parent=mmqgis_geometry_convert_form)
        self.new_geometry.setObjectName("new_geometry")
        self.verticalLayout.addWidget(self.new_geometry)
        self.gridLayout = QtWidgets.QGridLayout()
        self.gridLayout.setObjectName("gridLayout")
        self.label_5 = QtWidgets.QLabel(parent=mmqgis_geometry_convert_form)
        self.label_5.setObjectName("label_5")
        self.gridLayout.addWidget(self.label_5, 0, 1, 1, 1)
        self.label_4 = QtWidgets.QLabel(parent=mmqgis_geometry_convert_form)
        self.label_4.setObjectName("label_4")
        self.gridLayout.addWidget(self.label_4, 0, 0, 1, 1)
        self.merge_field = QtWidgets.QComboBox(parent=mmqgis_geometry_convert_form)
        self.merge_field.setObjectName("merge_field")
        self.gridLayout.addWidget(self.merge_field, 1, 0, 1, 1)
        self.attribute_handling = QtWidgets.QComboBox(parent=mmqgis_geometry_convert_form)
        ...
        self.label_6 = QtWidgets.QLabel(parent=mmqgis_geometry_convert_form)
        ...
        self.output_file_name = QgsFileWidget(parent=mmqgis_geometry_convert_form)
        self.output_file_name.setObjectName("output_file_name")
        self.verticalLayout.addWidget(self.output_file_name)
        self.status = QtWidgets.QProgressBar(parent=mmqgis_geometry_convert_form)
        self.status.setProperty("value", 24)
        self.status.setObjectName("status")
        self.verticalLayout.addWidget(self.status)
        self.buttonBox = QtWidgets.QDialogButtonBox(parent=mmqgis_geometry_convert_form)
        ...
        self.buttonBox.accepted.connect(mmqgis_geometry_convert_form.accept) # type: ignore
        self.buttonBox.rejected.connect(mmqgis_geometry_convert_form.reject) # type: ignore
