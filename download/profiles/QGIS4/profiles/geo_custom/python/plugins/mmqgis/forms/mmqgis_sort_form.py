...
class Ui_mmqgis_sort_form(object):
    def setupUi(self, mmqgis_sort_form):
        ...
        self.label = QtWidgets.QLabel(parent=mmqgis_sort_form)
        self.label.setObjectName("label")
        self.verticalLayout.addWidget(self.label)
        self.input_layer_name = QtWidgets.QComboBox(parent=mmqgis_sort_form)
        self.input_layer_name.setObjectName("input_layer_name")
        self.verticalLayout.addWidget(self.input_layer_name)
        self.label_2 = QtWidgets.QLabel(parent=mmqgis_sort_form)
        self.label_2.setObjectName("label_2")
        self.verticalLayout.addWidget(self.label_2)
        self.sort_fields = QtWidgets.QComboBox(parent=mmqgis_sort_form)
        self.sort_fields.setObjectName("sort_fields")
        self.verticalLayout.addWidget(self.sort_fields)
        self.label_3 = QtWidgets.QLabel(parent=mmqgis_sort_form)
        self.label_3.setObjectName("label_3")
        self.verticalLayout.addWidget(self.label_3)
        self.sort_direction = QtWidgets.QComboBox(parent=mmqgis_sort_form)
        self.sort_direction.setObjectName("sort_direction")
        self.verticalLayout.addWidget(self.sort_direction)
        self.label_4 = QtWidgets.QLabel(parent=mmqgis_sort_form)
        self.label_4.setObjectName("label_4")
        self.verticalLayout.addWidget(self.label_4)
        self.output_file_name = QgsFileWidget(parent=mmqgis_sort_form)
        self.output_file_name.setObjectName("output_file_name")
        self.verticalLayout.addWidget(self.output_file_name)
        self.status = QtWidgets.QProgressBar(parent=mmqgis_sort_form)
        self.status.setProperty("value", 24)
        self.status.setObjectName("status")
        self.verticalLayout.addWidget(self.status)
        self.buttonBox = QtWidgets.QDialogButtonBox(parent=mmqgis_sort_form)
        ...
        self.buttonBox.accepted.connect(mmqgis_sort_form.accept) # type: ignore
        self.buttonBox.rejected.connect(mmqgis_sort_form.reject) # type: ignore
