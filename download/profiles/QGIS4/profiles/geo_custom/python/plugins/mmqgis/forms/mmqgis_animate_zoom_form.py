# Form implementation generated from reading ui file 'mmqgis_animate_zoom_form.ui'
#
...
class Ui_mmqgis_animate_zoom_form(object):
    def setupUi(self, mmqgis_animate_zoom_form):
        ...
        mmqgis_animate_zoom_form.setWindowModality(QtCore.Qt.WindowModality.ApplicationModal)
        ...
        self.label_5 = QtWidgets.QLabel(parent=mmqgis_animate_zoom_form)
        ...
        self.print_layout = QtWidgets.QComboBox(parent=mmqgis_animate_zoom_form)
        self.print_layout.setObjectName("print_layout")
        self.verticalLayout.addWidget(self.print_layout)
        self.gridLayout = QtWidgets.QGridLayout()
        self.gridLayout.setObjectName("gridLayout")
        self.end_zoom = QtWidgets.QComboBox(parent=mmqgis_animate_zoom_form)
        self.end_zoom.setObjectName("end_zoom")
        self.gridLayout.addWidget(self.end_zoom, 5, 1, 1, 1)
        self.label_2 = QtWidgets.QLabel(parent=mmqgis_animate_zoom_form)
        self.label_2.setObjectName("label_2")
        self.gridLayout.addWidget(self.label_2, 4, 0, 1, 1)
        self.start_zoom = QtWidgets.QComboBox(parent=mmqgis_animate_zoom_form)
        self.start_zoom.setObjectName("start_zoom")
        self.gridLayout.addWidget(self.start_zoom, 5, 0, 1, 1)
        self.label_6 = QtWidgets.QLabel(parent=mmqgis_animate_zoom_form)
        ...
        self.label_9 = QtWidgets.QLabel(parent=mmqgis_animate_zoom_form)
        self.label_9.setObjectName("label_9")
        self.gridLayout.addWidget(self.label_9, 4, 1, 1, 1)
        self.label_3 = QtWidgets.QLabel(parent=mmqgis_animate_zoom_form)
        self.label_3.setObjectName("label_3")
        self.gridLayout.addWidget(self.label_3, 2, 0, 1, 1)
        self.label_4 = QtWidgets.QLabel(parent=mmqgis_animate_zoom_form)
        ...
        self.start_long = QtWidgets.QLineEdit(parent=mmqgis_animate_zoom_form)
        self.start_long.setObjectName("start_long")
        self.gridLayout.addWidget(self.start_long, 3, 0, 1, 1)
        self.start_lat = QtWidgets.QLineEdit(parent=mmqgis_animate_zoom_form)
        self.start_lat.setObjectName("start_lat")
        self.gridLayout.addWidget(self.start_lat, 1, 0, 1, 1)
        self.end_lat = QtWidgets.QLineEdit(parent=mmqgis_animate_zoom_form)
        self.end_lat.setObjectName("end_lat")
        self.gridLayout.addWidget(self.end_lat, 1, 1, 1, 1)
        self.end_long = QtWidgets.QLineEdit(parent=mmqgis_animate_zoom_form)
        self.end_long.setObjectName("end_long")
        self.gridLayout.addWidget(self.end_long, 3, 1, 1, 1)
        self.label_8 = QtWidgets.QLabel(parent=mmqgis_animate_zoom_form)
        self.label_8.setObjectName("label_8")
        self.gridLayout.addWidget(self.label_8, 2, 1, 1, 1)
        self.verticalLayout.addLayout(self.gridLayout)
        self.label_7 = QtWidgets.QLabel(parent=mmqgis_animate_zoom_form)
        self.label_7.setObjectName("label_7")
        self.verticalLayout.addWidget(self.label_7)
        self.frame_count = QtWidgets.QLineEdit(parent=mmqgis_animate_zoom_form)
        ...
        self.label = QtWidgets.QLabel(parent=mmqgis_animate_zoom_form)
        ...
        self.frame_directory = QgsFileWidget(parent=mmqgis_animate_zoom_form)
        self.frame_directory.setObjectName("frame_directory")
        self.verticalLayout.addWidget(self.frame_directory)
        self.status = QtWidgets.QProgressBar(parent=mmqgis_animate_zoom_form)
        self.status.setProperty("value", 24)
        self.status.setObjectName("status")
        self.verticalLayout.addWidget(self.status)
        self.buttonBox = QtWidgets.QDialogButtonBox(parent=mmqgis_animate_zoom_form)
        ...
        self.buttonBox.accepted.connect(mmqgis_animate_zoom_form.accept) # type: ignore
        self.buttonBox.rejected.connect(mmqgis_animate_zoom_form.reject) # type: ignore
